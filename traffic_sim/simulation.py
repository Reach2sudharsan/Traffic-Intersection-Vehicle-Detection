...
speeds = {'car':9, 'bus':7.2, 'truck':7.2, 'bike':10.0}  # average speeds of vehicles
...
class Main:
    ...
    while True:
        ...
        if current_time - last_screenshot_time >= screenshot_interval:
            """Take screenshots with both backgrounds."""
            timestamp = time.strftime("%Y%m%d-%H%M%S")

            # First screenshot with 'intersection_placeholder.png'
